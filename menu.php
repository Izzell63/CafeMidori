...
<!--<p style="color: white;text-decoration:underline;background-color:black;height:100px;font-size:25px;
margin-left: 10px;margin-right: 10px;margin-top: 10px;margin-bottom: 10px;padding: 10px;
border-radius: 10px;margin-top:280px;margin-left:30px;
text-shadow: 3px -3px 10px rgb(0, 0, 0), 0 0 10px rgb(0, 0, 0), 0 6px 10px rgb(0, 0, 0), -4px 4px 10px rgb(0, 0, 0);">Latest Menu</p>-->
    <div class="area">
        <?php
