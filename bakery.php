...
$total_result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM products  WHERE categories_id = 3");
...
<div class="page-container">
    ...
    <div class="area">
        ...
        $sql = "SELECT * FROM products 
                INNER JOIN categories ON products.categories_id = categories.categories_id  where products.categories_id = 3
